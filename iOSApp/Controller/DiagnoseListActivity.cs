...
namespace iOSApp
{
    [Register("DiagnoseListViewController")]
    public class DiagnoseListViewController : UITableViewController
    {
        ...
        public DiagnoseListViewController(UITableViewStyle style) : base(style)
        {
        }
        ...
        public override UITableViewCell GetCell(UITableView tableView, NSIndexPath indexPath)
        {
            ...
            string detail = $"个人姓名: {item.PatientName}";
        ...
        public override void RowSelected(UITableView tableView, NSIndexPath indexPath)
        {
            ...
            //显示检查报告详细视图
            DiagnoseDetailViewController diagnoseDetailVC = new DiagnoseDetailViewController();
            diagnoseDetailVC.HandlerSaveStudy += (s1, e1) => SaveStudy();
            this.NavigationController.PushViewController(diagnoseDetailVC, true);
        }
