...
namespace AndroidApp
{
    ...
    public class DiagnoseListActivity : Activity
    {
        ...
        private DiagnoseListAdapter MyAdapter;
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            MyAdapter = new DiagnoseListAdapter(this, MyStudyList.StudyList);
        ...
        private void LsvStudy_ItemClick(object sender, AdapterView.ItemClickEventArgs e)
        {
            ...
            StartActivity(typeof(DiagnoseDetailActivity));
        }
    ...
    //检查记录列表适配器
    public class DiagnoseListAdapter : BaseAdapter<Study>
    {
        private Activity context;
        private List<Study> items;

        public DiagnoseListAdapter(Activity context, List<Study> items)
        {
        ...
        public override View GetView(int position, View convertView, ViewGroup parent)
        {
            ...
            string detail = $"患者姓名: {item.PatientName}";
